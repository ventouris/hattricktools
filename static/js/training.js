var trainingcalc = function() {
      ...
      var skillvalues = {'GK':0.335,'Def':0.206,'DefPos':0.094,'Cross':0.315,'WingAtt':0.219,'PM':0.22,'PM 50%':0.11,'Sco':0.218,'Shoot':0.097,"Pass":0.237,'ThPass':0.178,"SP":0.941,"SP 25%":1.183};
      ...
      for (lev = startpoint; lev < 21; lev++) {
        ...
        console.log([lev,weekss.toFixed(1), resyears + "." + resdays])
        if (resdays < 10) {
         resdays = '0' + resdays;
        }
        if (resyears > 31) {
